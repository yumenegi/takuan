...
REM
REM Generated by Vivado on Fri Feb 20 00:55:05 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_axi_synth_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_axi_synth_vlog.prj -log xvlog.log
