...
#
# Script generated by Vivado on Fri Feb 06 19:05:42 -0600 2026
...
# script info
echo -e "mb_block.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
simulate()
{
  xsim mb_block -key {Behavioral:sim_1:Functional:mb_block} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d80c.protoinst" -protoinst "protoinst_files/mb_block.protoinst" -log simulate.log
}
...
Usage: mb_block.sh [-rerun]\n\
Usage: mb_block.sh [-reset_run]\n\
Usage: mb_block.sh [-clean]\n\
