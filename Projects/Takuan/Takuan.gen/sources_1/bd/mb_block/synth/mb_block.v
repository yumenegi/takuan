...
(* CORE_GENERATION_INFO = "mb_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mb_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=6,da_board_cnt=5,da_bram_cntlr_cnt=5,da_clkrst_cnt=3,da_ps7_cnt=4,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "mb_block.hwdef" *) 
module mb_block
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.FCLK_CLK1_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.FCLK_CLK1_0, CLK_DOMAIN mb_block_processing_system7_0_3_FCLK_CLK1, FREQ_HZ 24390244, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output FCLK_CLK1_0;
  ...
  wire [31:0]umeboshi_0_BRAM0_ADDR;
  wire umeboshi_0_BRAM0_CLK;
  wire [31:0]umeboshi_0_BRAM0_DIN;
  wire [31:0]umeboshi_0_BRAM0_DOUT;
  wire umeboshi_0_BRAM0_EN;
  wire umeboshi_0_BRAM0_RST;
  wire [3:0]umeboshi_0_BRAM0_WE;
  wire [31:0]umeboshi_0_BRAM1_ADDR;
  wire umeboshi_0_BRAM1_CLK;
  wire [31:0]umeboshi_0_BRAM1_DIN;
  wire [31:0]umeboshi_0_BRAM1_DOUT;
  wire umeboshi_0_BRAM1_EN;
  wire umeboshi_0_BRAM1_RST;
  wire [3:0]umeboshi_0_BRAM1_WE;

  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > mb_block axi_bram_ctrl_0_bram_osc_a" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  mb_block_axi_bram_ctrl_0_2 axi_bram_ctrl_0
  ...
  mb_block_axi_bram_ctrl_0_bram_1 axi_bram_ctrl_0_bram_osc_a
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(umeboshi_0_BRAM0_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(umeboshi_0_BRAM0_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(umeboshi_0_BRAM0_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(umeboshi_0_BRAM0_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(umeboshi_0_BRAM0_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(umeboshi_0_BRAM0_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(umeboshi_0_BRAM0_WE));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x42000000 32 > mb_block axi_bram_ctrl_1_bram_osc_b" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  mb_block_axi_bram_ctrl_1_1 axi_bram_ctrl_1
  ...
  mb_block_axi_bram_ctrl_1_bram_0 axi_bram_ctrl_1_bram_osc_b
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_1_BRAM_PORTA_ADDR}),
        .addrb(umeboshi_0_BRAM1_ADDR),
        .clka(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .clkb(umeboshi_0_BRAM1_CLK),
        .dina(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .dinb(umeboshi_0_BRAM1_DIN),
        .douta(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .doutb(umeboshi_0_BRAM1_DOUT),
        .ena(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .enb(umeboshi_0_BRAM1_EN),
        .rsta(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .rstb(umeboshi_0_BRAM1_RST),
        .wea(axi_bram_ctrl_1_BRAM_PORTA_WE),
        .web(umeboshi_0_BRAM1_WE));
  mb_block_axi_smc_2 axi_smc
  ...
  (* BMM_INFO_PROCESSOR = "arm > mb_block axi_bram_ctrl_0 mb_block axi_bram_ctrl_1" *) 
  (* KEEP_HIERARCHY = "YES" *) 
  mb_block_processing_system7_0_3 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  mb_block_rst_ps7_0_100M_1 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  mb_block_umeboshi_0_2 umeboshi_0
       (.audio_out(audio_out),
        .audio_tick(audio_tick_0),
        .audio_valid(audio_valid),
        .axi_synth_engine_aclk(processing_system7_0_FCLK_CLK0),
        .axi_synth_engine_araddr(axi_smc_M00_AXI_ARADDR),
        .axi_synth_engine_aresetn(rst_ps7_0_100M_peripheral_aresetn),
        .axi_synth_engine_arprot(axi_smc_M00_AXI_ARPROT),
        .axi_synth_engine_arready(axi_smc_M00_AXI_ARREADY),
        .axi_synth_engine_arvalid(axi_smc_M00_AXI_ARVALID),
        .axi_synth_engine_awaddr(axi_smc_M00_AXI_AWADDR),
        .axi_synth_engine_awprot(axi_smc_M00_AXI_AWPROT),
        .axi_synth_engine_awready(axi_smc_M00_AXI_AWREADY),
        .axi_synth_engine_awvalid(axi_smc_M00_AXI_AWVALID),
        .axi_synth_engine_bready(axi_smc_M00_AXI_BREADY),
        .axi_synth_engine_bresp(axi_smc_M00_AXI_BRESP),
        .axi_synth_engine_bvalid(axi_smc_M00_AXI_BVALID),
        .axi_synth_engine_rdata(axi_smc_M00_AXI_RDATA),
        .axi_synth_engine_rready(axi_smc_M00_AXI_RREADY),
        .axi_synth_engine_rresp(axi_smc_M00_AXI_RRESP),
        .axi_synth_engine_rvalid(axi_smc_M00_AXI_RVALID),
        .axi_synth_engine_wdata(axi_smc_M00_AXI_WDATA),
        .axi_synth_engine_wready(axi_smc_M00_AXI_WREADY),
        .axi_synth_engine_wstrb(axi_smc_M00_AXI_WSTRB),
        .axi_synth_engine_wvalid(axi_smc_M00_AXI_WVALID),
        .bram0_addr_b(umeboshi_0_BRAM0_ADDR),
        .bram0_clkb(umeboshi_0_BRAM0_CLK),
        .bram0_data_b(umeboshi_0_BRAM0_DOUT),
        .bram0_din_b(umeboshi_0_BRAM0_DIN),
        .bram0_enb(umeboshi_0_BRAM0_EN),
        .bram0_rstb(umeboshi_0_BRAM0_RST),
        .bram0_web(umeboshi_0_BRAM0_WE),
        .bram1_addr_b(umeboshi_0_BRAM1_ADDR),
        .bram1_clkb(umeboshi_0_BRAM1_CLK),
        .bram1_data_b(umeboshi_0_BRAM1_DOUT),
        .bram1_din_b(umeboshi_0_BRAM1_DIN),
        .bram1_enb(umeboshi_0_BRAM1_EN),
        .bram1_rstb(umeboshi_0_BRAM1_RST),
        .bram1_web(umeboshi_0_BRAM1_WE));
endmodule
