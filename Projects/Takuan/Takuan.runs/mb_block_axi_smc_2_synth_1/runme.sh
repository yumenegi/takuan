...
HD_PWD='C:/Users/hause/Documents/Vivado/Projects/Takuan/Takuan.runs/mb_block_axi_smc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_axi_smc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_axi_smc_2.tcl
